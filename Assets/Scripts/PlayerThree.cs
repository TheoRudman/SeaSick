...
public class PlayerThree : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            tileNumber = 0;
            //Debug.Log("PLAYER THREE Landed on PLUS");
            //Debug.Log(tileNum);
        ...
        {
            tileNumber = 1;
           // Debug.Log("PLAYER THREE Landed on MINUS");
            //Debug.Log(tileNum);
        ...
        {
            tileNumber = 2;
            //Debug.Log("PLAYER THREE Landed on EMPTY");
            //Debug.Log(tileNum);
        ...
        {
            tileNumber = 3;
            //Debug.Log("PLAYER THREE Landed on ITEM");
            //Debug.Log(tileNum);
        ...
        {
            tileNumber = 4;
            //Debug.Log("PLAYER THREE Landed on CHALLENGE");
            //Debug.Log(tileNum);
            menuManager.tileNum = 4;
        }
        if (tileNumber == 6)
        {
            Debug.Log("PLAYER THREE ERROR: TILE NUM RESET");
